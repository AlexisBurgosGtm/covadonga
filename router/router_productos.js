...
router.post("/inventario_productos_export", async(req,res)=>{
        ...
        if(existencia=='SI'){
                ...
                SELECT  
                        view_invsaldo_productos_empresas.EMPRESA AS BODEGA,
                        view_invsaldo_productos_empresas.TIPO, 
                        view_invsaldo_productos_empresas.CODPROD AS CODIGO, 
                        view_invsaldo_productos_empresas.DESPROD AS PRODUCTO, 
                        view_invsaldo_productos_empresas.DESMARCA AS MARCA, 
                        productos.CODMEDIDA AS EMPAQUE,
                        ISNULL(invsaldo_inventario_sucursales.TOTALUNIDADES, 0) AS EXISTENCIA, 
                         productos.COSTO, 
                        ISNULL(invsaldo_inventario_sucursales.TOTALCOSTO, 0) AS TOTALCOSTO 
                FROM     EMPLEADOS RIGHT OUTER JOIN
                ...
                SELECT view_invsaldo_productos_empresas.EMPRESA AS BODEGA,
                        view_invsaldo_productos_empresas.TIPO, 
                        view_invsaldo_productos_empresas.CODPROD AS CODIGO, 
                        view_invsaldo_productos_empresas.DESPROD AS PRODUCTO, 
                        view_invsaldo_productos_empresas.DESMARCA AS MARCA, 
