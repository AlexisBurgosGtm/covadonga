let GF = {
        ...
        data_listado_empresas_conta:()=>{

            return new Promise((resolve,reject)=>{

                axios.post(GlobalUrlCalls + '/general/select_empresas_conta_listado')
                .then((response) => {
                    if(response.status.toString()=='200'){
                        let data = response.data;
                        if(data.toString()=="error"){
        ...
        insert_empresa_conta:(nit,razon_social,nombre_comercial,direccion)=>{

            return new Promise((resolve,reject)=>{

                axios.post(GlobalUrlCalls + '/general/insert_empresa_conta', {
                    nit:nit,
        ...
        edit_empresa_conta:(codemp,nit,razon_social,nombre_comercial,direccion)=>{

            return new Promise((resolve,reject)=>{

                axios.post(GlobalUrlCalls + '/general/edit_empresa_conta', {
                    codemp:codemp,
                    nit:nit,
                    razon_social:razon_social,
                    nombre_comercial:nombre_comercial,
        ...
        //resuelve con 'ok' si borro, o con 'en_uso' si la empresa ya tiene documentos
        delete_empresa_conta:(codemp)=>{

            return new Promise((resolve,reject)=>{

                axios.post(GlobalUrlCalls + '/general/delete_empresa_conta', {codemp:codemp})
                .then((response) => {
                    if(response.status.toString()=='200'){
                        let data = response.data;
                        if(data.toString()=="error"){
                            ...
                            let resultado = (data.recordset && data.recordset[0]) 
                                            ? data.recordset[0].RESULTADO : '';
                            if(resultado==''){
                                reject();
                            }else{
                                resolve(resultado);
        ...
        data_bi_resumen_compras_conta:(mes,anio)=>{

            return new Promise((resolve,reject)=>{

                axios.post(GlobalUrlCalls + '/bi/resumen_empresas_conta',{mes:mes,anio:anio})
                .then((response) => {
                    if(response.status.toString()=='200'){
                        let data = response.data;
                        if(data.toString()=="error"){
...
let PERMISOS = {
    data:()=>{
        ...
        let data_permisos = [
            ...
            {nivel:1,vista:'EMPRESAS_CONTA',autorizado:true},
            ...
            {nivel:2,vista:'EMPRESAS_CONTA',autorizado:false},
            ...
            {nivel:3,vista:'EMPRESAS_CONTA',autorizado:false},
            ...
            {nivel:4,vista:'EMPRESAS_CONTA',autorizado:true},
        ...
        let autorizado = false;
         ...
         let data_permisos = [
            ...
            {nivel:1,vista:'CONFIGURACIONES',autorizado:true},
                ...
                {nivel:2,vista:'PROYECTOS',autorizado:true},
                {nivel:2,vista:'EMPRESAS_CONTA',autorizado:false},
                {nivel:2,vista:'CONFIGURACIONES',autorizado:true},
            {nivel:3,vista:'TRASLADOS_ENTRADA',autorizado:true},
            {nivel:3,vista:'TRASLADOS_SALIDA',autorizado:true},
            {nivel:3,vista:'ENTRADA_BODEGA',autorizado:true},
            {nivel:3,vista:'SALIDA_CONSUMO',autorizado:true},
            {nivel:3,vista:'HERRAMIENTAS',autorizado:true},
            {nivel:3,vista:'COMPRAS',autorizado:true},
            {nivel:3,vista:'INVENTARIOS',autorizado:true},
            {nivel:3,vista:'DOCUMENTOS',autorizado:false},
            {nivel:3,vista:'PRODUCTOS',autorizado:false},
            {nivel:3,vista:'EMPLEADOS',autorizado:false},
