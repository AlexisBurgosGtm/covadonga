let F = {
      ...
      setMoneda_BACKUP: function(num,signo) {
          num = num.toString().replace(/\$|\,/g, '');
          if (isNaN(num)) num = "0";
          let sign = (num == (num = Math.abs(num)));
          num = Math.floor(num * 100 + 0.50000000001);
      ...
      //escapa texto que viene de la base antes de meterlo en un innerHTML
      ...
      let str =`<option value='1'>Enero</option>
        ...
        document.getElementById(idContainer).value = mes;
      ...
      let str =`<option value='2017'>2017</option>
          ...
          document.getElementById(idContainer).innerHTML = str;
            ...
            document.getElementById(idContainer).value = anio;
