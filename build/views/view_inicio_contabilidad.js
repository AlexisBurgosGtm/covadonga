        ...
        vista_listado:()=>{
            ...
            <div class="card card-rounded shadow">
                <div class="card-body p-4">
                    ...
                    <h4 class="negrita text-danger">ARCHIVO DE COMPRAS PARA CONTABILIDAD</h4>
...
function addListeners(){
    ...
    document.title = 'ARCHIVO DE CONTABILIDAD';
    ...
    .then((data)=>{
        ...
        document.getElementById('cmbTipo').innerHTML = str;
    })
    .catch(()=>{
         document.getElementById('cmbTipo').innerHTML = "<option value='0'>SIN EMPRESA</option>";
    });
...
function tbl_movimientos(){
    ...
    let sucursal = document.getElementById('cmbTipo').value;
    ...
    GF.data_documentos_conta(sucursal,mes,anio)
    .then((data)=>{
        let str = '';
        data.recordset.map((r)=>{
            
            varTotalImporte += Number(r.TOTALCOSTO);
            ...
            <tr>
                ...
                <td>${r.PROVEEDOR}
                    <br>
                    <small class="negrita text-base">NIT: ${r.NIT_PROVEEDOR}</small>
                    <br>
                    <small class="">Dir: ${r.DIRPROV}</small>
                </td>
                <td class="negrita text-danger">${F.setMoneda(r.TOTALCOSTO,'Q')}</td>
        ...
        varTotalBase = (varTotalImporte / 1.12);
        varTotalIva =  (varTotalImporte - varTotalBase)

        document.getElementById('lbTotalImporte').innerText = `Importe: ${F.setMoneda(varTotalImporte,'Q')}`;
        document.getElementById('lbTotalIva').innerText = `IVA: ${F.setMoneda(varTotalIva,'Q')}`;
        document.getElementById('lbTotalBase').innerText = `Base: ${F.setMoneda(varTotalBase,'Q')}`;
    ...
    .catch(()=>{
        ...
        document.getElementById('lbTotalIva').innerText =  `---`;
        document.getElementById('lbTotalBase').innerText = `---`;
